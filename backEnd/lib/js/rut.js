...
function formatoRut2() {
    var formLogin = document.getElementById("login2");
    var sRut1 = formLogin.username.value.toUpperCase();
    sRut1 = quitarEspacios(sRut1);
    // var sRut1 = rut.value;
    // contador de para saber cuando insertar el . o la -
    var nPos = 0;
    ...
    // Pasamos al campo el valor formateado
    // rut.value = sRut.toUpperCase();
    document.getElementById("login2").username.value = sRut.toUpperCase();
