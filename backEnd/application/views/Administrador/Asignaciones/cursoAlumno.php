            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-sm-4">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong>Modulo Cursos y Alumnos</strong>
                        </li>
                    </ol>
                </div>
            ...
            <div class="wrapper wrapper-content  animated fadeInRight">
                <div class="row">
                    <div class="col-lg-3">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title" style="background-color: #0d8ddb;">
                                <h5 style="color: white">Cursos y Alumnos </h5>
                            </div>
                    ...
                    <div class="col-lg-9">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title" style="background-color: #0d8ddb;">
                                <h5 style="color: white">Relacion Curso-Alumno </h5>
                            </div>
                            <div class="ibox-content" style="padding: 0px;">
                                <div class="row" style="padding: 20px;">
                                    <div class="col-md-12">
                                        <div class="row" style="padding: 20px;">
                                            <h2><strong>Registros Curso-Alumno</strong></h2>
                                            <div class="table-responsive">
                                                <table id="tabla_cursoAlumno" class="table table-striped table-bordered table-hover dataTables-cursoAlumno">
                                                    <thead>
                                                        <tr>
                                                            <th>ID</th>
                                                            <th>Nombre Curso</th>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <small class="font-bold">En este modal podras ver todos los alumnos asociados a un Curso.</small>
                </div>
    ...
    <script>
        $(function() {
            ...
            $(document).ready(function() {
                ...
                $('.dataTables-cursoAlumno').DataTable({
                    language: {
                    ...
                    "ajax": {
                        url: "<?php echo site_url() ?>getTotalCursosAlumnos",
                        type: 'GET'
                    },
                    "columnDefs": [{
                            "targets": 3,
                ...
                $("body").on("click", "#btnVerAlumnos", function(e) {
                    ...
                    getTablaAlumnosCurso($(id).text());

                });

                $("#btnAgregarRelacion").click(function(e) {
                    e.preventDefault();
                    addRelacionAlumnoCurso();
                    var table = $('#tabla_cursoAlumno').DataTable();
