    ...
    <div id="wrapper">
        <div id="page-wrapper" class="gray-bg" style="padding: 0px; margin: 0px;">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-sm-4">
                    <h2>Modulo Cursos y Materias</h2>
                    <ol class="breadcrumb">
                        <li>
                        ...
                        <li class="active">
                            <strong>Modulo Cursos y Materias</strong>
                        </li>
                    </ol>
                </div>
            ...
            <div class="wrapper wrapper-content  animated fadeInRight">
                <div class="row">
                    <div class="col-lg-3">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title" style="background-color: #0d8ddb;">
                                <h5 style="color: white">Cursos y Materias </h5>
                            </div>
                            <div class="ibox-content" style="padding: 0px;">
                                <div class="row" style="padding: 20px;">
                                    <div class="col-md-12">
                                        <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12"><label for="getSelectProfesor">Alumnos Asociados al</label>
                                            <select class="form-control select2" multiple="" id="getSelectMaterias">

                                            </select>
                                        </div>

                                        <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12"><label for="getSelectProfesor">Siguiente Curso</label>
                    ...
                    <div class="col-lg-9">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title" style="background-color: #0d8ddb;">
                                <h5 style="color: white">Relacion Curso-Materia </h5>
                            </div>
                            <div class="ibox-content" style="padding: 0px;">
                                <div class="row" style="padding: 20px;">
                                    <div class="col-md-12">
                                        <div class="row" style="padding: 20px;">
                                            <h2><strong>Registros Curso-Materia</strong></h2>
                                            <div class="table-responsive">
                                                <table id="tabla_cursoMateria" class="table table-striped table-bordered table-hover dataTables-cursoMateria">
                                                    <thead>
                                                        <tr>
                                                            <th>ID</th>
                                                            <th>Nombre Curso</th>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Ver Materias Asociadass</h4>
                    <small class="font-bold">En este modal podras ver todos los materias asociados a un Curso.</small>
                </div>
    ...
    <script>
        $(function() {
            ...
            $(document).ready(function() {
                ...
                getSelectCurso();
                getSelectMaterias();
                $('.dataTables-cursoMateria').DataTable({
                    language: {
                    ...
                    "ajax": {
                        url: "<?php echo site_url() ?>getTotalMateriasCurso",
                        type: 'GET'
                    },
                    "columnDefs": [{
                            "targets": 3,
                            "data": null,
                            "defaultContent": '<button type="button" id="btnVerMaterias" class="btn btn-info" data-toggle="modal" data-target="#myModal5"><i class="glyphicon glyphicon-pencil"></i></button>'
                        }
                ...
                $("body").on("click", "#btnVerMaterias", function(e) {
                    e.preventDefault();
                    var id = $(this).parent().parent().children()[0];
                    getTablaMateriasCurso($(id).text());

                });

                $("#btnAgregarRelacion").click(function(e) {
                    e.preventDefault();
                    addRelacionMateriaCurso();
                    var table = $('#tabla_cursoMateria').DataTable();
