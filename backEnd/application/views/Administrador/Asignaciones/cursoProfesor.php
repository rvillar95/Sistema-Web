                ...
                $(document).ready(function () {
                    ...
                    $('.dataTables-cursoProfesor').DataTable({
                        ...
                        buttons: [
                            {extend: 'copy'},
                            {extend: 'csv'},
                            {extend: 'excel', title: 'Lista de Curso - Profesor'},
                            {extend: 'pdf', title: 'Lista de Curso - Profesor'},
                            {extend: 'print',
                    ...
                    $('.dataTables-Profesores').DataTable({
                        ...
                        buttons: [
                            {extend: 'copy'},
                            {extend: 'csv'},
                            {extend: 'excel', title: 'Lista de Profesores Asociados'},
                            {extend: 'pdf', title: 'Lista de Profesores Asociados'},
                            {extend: 'print',
                                customize: function (win) {
                                    $(win.document.body).addClass('white-bg');
                                    $(win.document.body).css('font-size', '10px');
