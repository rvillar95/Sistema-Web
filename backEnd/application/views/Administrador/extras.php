                        ...
                        <div class="col-lg-6">
                            <div class="ibox float-e-margins">
                                <div class="ibox-title" style="background-color: #0d8ddb;">
                                    <h5 style="color: white">Crear Parentesco</h5> 
                                ...
                                <div class="ibox-content" style="padding: 0px;">
                                    <div class="row" style="padding: 20px;">
                                        <div class="col-md-12">
                                            <br/>
                                            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12"><label>Nombre Parentesco</label> <input required type="text" id="parentesco" placeholder="Ingrese nombre del Parentescos" class="form-control"></div>
                                            <div class="form-group form-group col-lg-6 col-md-6 col-sm-6 col-xs-6"><button type="submit" id="btnAgregarParentesco"  class="btn btn-primary" style="background-color: black; color: white; ">Agregar Parentesco</button></div> 
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                $(document).ready(function () {
                    ...
                    $('.dataTables-parentesco').DataTable({
                        ...
                        buttons: [
                            {extend: 'copy'},
                            {extend: 'csv'},
                            {extend: 'excel', title: 'Lista de Parentescos'},
                            {extend: 'pdf', title: 'Lista de Parentescos'},
                            {extend: 'print',
                    ...
                    $('.dataTables-nacionalidad').DataTable({
                        ...
                        buttons: [
                            {extend: 'copy'},
                            {extend: 'csv'},
                            {extend: 'excel', title: 'Lista de Nacionalidad'},
                            {extend: 'pdf', title: 'Lista de Nacionalidad'},
                            {extend: 'print',
                                customize: function (win) {
                                    $(win.document.body).addClass('white-bg');
                                    $(win.document.body).css('font-size', '10px');
                    ...
                    $("#btnAgregarParentesco").click(function (e) {
                        e.preventDefault();
                        agregarParentesco();
                         var table = $('#tabla_parentesco').DataTable();
                        table.ajax.reload(function (json) {
                            $('#btnAgregarParentesco').val(json.lastInput);
                        });
                    });
