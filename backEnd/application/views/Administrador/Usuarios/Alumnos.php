                            ...
                            <div class="ibox float-e-margins">
                                ...
                                <div class="ibox-content" style="padding: 0px;">
                                    <div class="row" style="padding: 20px;">
                                        <div class="col-md-12">
                                            <br/>
                                            <form   id="login" name="login" method="post" action="http://127.0.0.1/Tesis/backEnd/addAlumno" enctype="multipart/form-data">
                                                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12"><label>Rut Alumno</label> <input required type="text" name="j_username" placeholder="Rut" class="form-control" autocomplete="off" onfocus="rut(this.value);" onkeypress="return esRutLogin(event)" onkeyup="this.value = this.value.toUpperCase();" onblur="formatoRut()"></div>
                                                ...
                                                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12"><label>Número Alumno</label> <input required type="text" name="numero" placeholder="Ingrese Numero del Alumno" class="form-control"></div>
                                                ...
                                                <div class="form-group form-group col-lg-6 col-md-6 col-sm-6 col-xs-6"><button type="submit" class="btn btn-primary" style="background-color: black; color: white; ">Agregar Alumno</button></div> 
                                            </form>
                                        </div>
                                    </div>
                                </div>
                                                        ...
                                                        $(document).ready(function () {
                                                            ...
                                                            $('.dataTables-usuarios').DataTable({
                                                                ...
                                                                buttons: [
                                                                    {extend: 'copy'},
                                                                    {extend: 'csv'},
                                                                    {extend: 'excel', title: 'Lista de Alumnos'},
                                                                    {extend: 'pdf', title: 'Lista de Alumnos'},
                                                                    {extend: 'print',
