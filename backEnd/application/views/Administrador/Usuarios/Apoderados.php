                                ...
                                <div class="row" style="padding: 20px;">
                                    <div class="col-md-12">
                                        ...
                                        <form id="prueba" name="login" method="post" enctype="multipart/form-data">
                                            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12"><label>Rut Apoderado</label><input id="username" required type="text" name="j_username" class="form-control" oninput="checkRutA(this)"></div>
                                            ...
                                            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12"><label>Telefono Apoderado</label> <input required type="text" name="numero" placeholder="Ingrese Numero del Apoderado" class="form-control soloNumeros"></div>
                                            ...
                                            <div class="form-group form-group col-lg-6 col-md-6 col-sm-6 col-xs-6"><button type="submit" id="btn" class="btn btn-primary" style="background-color: black; color: white; ">Agregar Apoderado</button></div>
        ...
        $(function() {
            ...
            $(document).ready(function() {
                ...
                $('#prueba').on('submit', function(event) {
                    ...
                    $.ajax({
                        url: "<?php echo base_url(); ?>addApoderado",
                        method: "POST",
                ...
                $("body").on("click", "#btn2", function(e) {
                    ...
                    event.preventDefault();
                    $.ajax({
                        url: "<?php echo base_url(); ?>editarApoderado",
                        method: "POST",
                        data: new FormData(document.getElementById("editApo")),
                        contentType: false,
                        cache: false,
                        processData: false,
                        success: function(data) {
                            ...
                            if (data == "ok") {
                                toastr.success("", "Apoderado editado con Exito.")
                            } else if (data == "error") {
                                toastr.warning("", "Error al editar apoderado.")
                            } else if (data == "falta") {
                                toastr.warning("", "Faltan datos por completar.")
                            }
                        }
