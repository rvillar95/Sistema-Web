            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-sm-4">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong>Modulo Profesores</strong>
                        </li>
                    </ol>
                </div>
            ...
            <div class="wrapper wrapper-content  animated fadeInRight">
                <div class="row">
                    <div class="col-lg-3">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title" style="background-color: #0d8ddb;">
                                <h5 style="color: white">Gestionar Profesores</h5>
                            </div>
                                ...
                                <div class="row" style="padding: 20px;">
                                    <div class="col-md-12">
                                        ...
                                        <form id="prueba" name="login" method="post" enctype="multipart/form-data">
                                            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12"><label>Rut Profesor</label><input id="username" required type="text" name="j_username" class="form-control" oninput="checkRutA(this)"></div>
                                            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12"><label>Nombres Profesor</label> <input required type="text" name="nombre" placeholder="Ingrese nombre del Profesor" class="form-control"></div>
                                            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12"><label>Apellidos Profesor</label> <input required type="text" name="apellido" placeholder="Ingrese apellido del Profesor" class="form-control"></div>
                                            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12"><label>Fecha Nacimiento Profesor</label> <input required type="date" name="nacimiento" placeholder="Ingrese Fecha Nacimiento del Profesor" class="form-control"></div>
                                            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12"><label>Telefono Profesor</label> <input required type="text" name="numero" placeholder="Ingrese Numero del Profesor" class="form-control soloNumeros"></div>
                                            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12"><label>Correo Profesor</label> <input required type="email" name="correo" placeholder="Ingrese Correo del Profesor" class="form-control"></div>
                                            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12"><label>Foto Profesor</label> <input type="file" name="foto" placeholder="Seleccione el archivo" class="form-control"></div>
                                            <div class="form-group form-group col-lg-6 col-md-6 col-sm-6 col-xs-6"><button type="submit" id="btn" class="btn btn-primary" style="background-color: black; color: white; ">Agregar Profesor</button></div>
                                        </form>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-9">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title" style="background-color: #0d8ddb;">
                                <h5 style="color: white">Tabla Profesores</h5>
                            </div>
                            <div class="ibox-content" style="padding: 0px;">
                                <div class="row" style="padding: 20px;">
                                    <h2><strong>Registros de Profesores</strong></h2>
                                    <div class="table-responsive">
                                        <table id="tabla_profesor" class="table table-striped table-bordered table-hover dataTables-profesor">
                                            <thead>
                                                <tr>
                                                    <th>ID</th>
                                                    <th>Rut</th>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <small class="font-bold">En este modulo podras editar todos los datos de cualquier Profesor.</small>
                </div>
                <div class="modal-body" id="info-profesores">
                </div>
            </div>
        </div>
    </div>
        ...
        $(function() {
            ...
            $(document).ready(function() {
                ...
                $('#prueba').on('submit', function(event) {
                    ...
                    $.ajax({
                        url: "<?php echo base_url(); ?>addProfesor",
                        method: "POST",
                ...
                $("body").on("click", "#btn2", function(e) {
                    ...
                    event.preventDefault();
                    $.ajax({
                        url: "<?php echo base_url(); ?>editarProfesor",
                        method: "POST",
                        data: new FormData(document.getElementById("editPro")),
                        contentType: false,
                        cache: false,
                        processData: false,
                        success: function(data) {
                            ...
                            if (data == "ok") {
                                toastr.success("", "Profesor editado con Exito.")
                            } else if (data == "error") {
                                toastr.warning("", "Error al editar Profesor.")
                            } else if (data == "falta") {
                ...
                $('.dataTables-profesor').DataTable({
                    ...
                    "columnDefs": [{
                            "targets": 6,
                            "data": null,
                            "defaultContent": '<button type="button" id="btnEditarProfesor" class="btn btn-info" data-toggle="modal" data-target="#myModal5"><i class="glyphicon glyphicon-pencil"></i></button>'
                        }
                ...
                $("body").on("click", "#btnEditarProfesor", function(e) {
                    e.preventDefault();
                    var id = $(this).parent().parent().children()[0];
                    getDatosProfesor($(id).text());
