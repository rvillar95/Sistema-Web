            ...
            <div class="wrapper wrapper-content  animated fadeInRight">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <h3 align="center">En este modulo podras importar Profesores.</h3>
                        <form align="center" method="post" id="import_form" enctype="multipart/form-data">
                            ...
                            <br />
                            <input type="submit" id="imp" name="import" value="Importar Profesores" class="btn btn-info" />
                        </form>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#import_form').on('submit', function(event) {
                ...
                $.ajax({
                    url: "<?php echo base_url(); ?>insertarExcelProfesor",
                    method: "POST",
