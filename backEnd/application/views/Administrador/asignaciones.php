        ...
        <div id="wrapper">
            <div id="page-wrapper" class="gray-bg" style="padding: 0px; margin: 0px;">
                ...
                <div class="row wrapper border-bottom white-bg page-heading">
                    <div class="col-sm-4">
                        <h2>Modulo Asignaciones</h2>
                        <ol class="breadcrumb">
                            <li>
                                <a href="<?php echo base_url() ?>Administrador">Menu Principal</a>
                            </li>
                            <li class="active">
                                <strong>Modulo Asignaciones</strong>
                            </li>
                        </ol>
                    </div>
                ...
                <div class="wrapper wrapper-content  animated fadeInRight">
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="ibox float-e-margins">
                                ...
                                <div class="ibox-content" style="padding: 0px;">
                                    <a href=" <?php echo base_url(); ?>cursoProfesor">
                                        <center>
                        ...
                        <div class="col-lg-4">
                            <div class="ibox float-e-margins">
                                ...
                                <div class="ibox-content" style="padding: 0px;">
                                    <a href=" <?php echo base_url(); ?>cursoAlumno">
                                        <center>
                                            <div class="div-img sty" >
                                                <img src="<?php echo base_url() ?>lib/img/talleres.jpg"  class="img-responsive img" alt=""/>
                                            </div>
                        ...
                        <div class="col-lg-4">
                            <div class="ibox float-e-margins">
                                ...
                                <div class="ibox-content" style="padding: 0px;">
                                    <a href=" <?php echo base_url(); ?>cursoMateria">
                                        <center>
                                            <div class="div-img sty" >
                                                <img src="<?php echo base_url() ?>lib/img/talleres.jpg"  class="img-responsive img" alt=""/>
                                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="ibox float-e-margins">
                                <div class="ibox-title" style="background-color: #0d8ddb;">
                                    <h5 style="color: white">Talleres y Alumnos </h5> 
                                </div>
                                <div class="ibox-content" style="padding: 0px;">
                                    <a href=" <?php echo base_url(); ?>tallerAlumno">
                                        <center>
                                            <div class="div-img sty" >
                                                <img src="<?php echo base_url() ?>lib/img/talleres.jpg"  class="img-responsive img" alt=""/>
                                            </div>
